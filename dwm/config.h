...
static const char *altbarcmd                   = "$HOME/dwm/polybar/launch.sh";
...
static const char *const autostart[] = {
    ...
    "dunst", NULL,
    "picom", "-b", NULL,
    "sh", "-c", "feh --randomize --bg-fill ~/backgrounds/*", NULL,
...
static Key keys[] = {
    ...
    { MODKEY,                       XK_p,                      spawn,          SHCMD ("flameshot full -p /home/ujstor/Screenshots/")},
    { MODKEY|ShiftMask,             XK_p,                      spawn,          SHCMD ("flameshot gui -p /media/ujstor/Screenshots/")},
    ...
    { MODKEY|ShiftMask,             XK_w,                      spawn,          SHCMD ("feh --randomize --bg-fill ~/backgrounds/*")},
